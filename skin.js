	...
	this.addSkin=function() {
		...
		me.__54.logicBlock_position = function() {
			...
			if (me.__54.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__54.style.transition='right 500ms ease 0ms, bottom 500ms ease 0ms';
				if (me.__54.ggCurrentLogicStatePosition == 0) {
					me.__54.style.right='0px';
					me.__54.style.bottom='0%';
				}
				else {
					me.__54.style.right='0px';
					me.__54.style.bottom='-100%';
				}
			}
		}
		...
		me.__55.logicBlock_position = function() {
			...
			if (me.__55.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__55.ggCurrentLogicStatePosition == 0) {
					...
					me.__55.style.top='-52%';
				}
				else {
					me.__55.style.left='0px';
					me.__55.style.top='-55%';
				}
			}
		}
		...
		el=me.__3959=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__3959;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		el.ggId="\uacf5\uac04\uc120\ud0dd \uc774\ubbf8\uc9c0-3959";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		me.__3959.ggUpdatePosition=function (useTransition) {
		}
		el=me.__391=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__391;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		el.ggUpdate = function(filter) {
			if(me.__391.ggUpdating == true) return;
			me.__391.ggUpdating = true;
			var el=me.__391;
			var curNumRows = 0;
			curNumRows = me.__391.ggNumRepeat;
			...
			var centerOffsetVert = 0;
				me.__391.ggCloneOffsetChanged = false;
			}
			...
			tourNodes = me.__391.getFilteredNodes(tourNodes, filter);
			me.__391.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__391.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__391.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__391.ggWidth) + 'px';
				parameter.width=me.__391.ggWidth + 'px';
				parameter.height=me.__391.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__391_Class(nodeId, me, el, parameter);
				currentIndex++;
			...
			me.__391.ggNodeCount = me.__391.ggNumFilterPassed;
			me.__391.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__391.parentNode && me.__391.parentNode.classList.contains('ggskin_subelement') && me.__391.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__391.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "39";
		el.ggId="\uac00\uad6c\uc788\uc74c-39";
		...
		me.__391.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__391.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__391.ggCurrentLogicStateSize = newLogicStateSize;
				me.__391.style.transition='width 0s, height 0s';
				if (me.__391.ggCurrentLogicStateSize == 0) {
					me.__391.ggWidth=100;
					me.__391.ggHeight=150;
					me.__391.ggUpdate();
					skin.updateSize(me.__391);
				}
				else {
					me.__391.ggWidth=150;
					me.__391.ggHeight=180;
					me.__391.ggUpdate();
					skin.updateSize(me.__391);
				}
			}
		}
		me.__391.logicBlock_size();
		me.__391.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("39") != -1))
			)
			{
			...
			if (me.__391.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__391.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__391.style.transition='width 0s, height 0s';
				if (me.__391.ggCurrentLogicStateVisible == 0) {
					me.__391.style.visibility=(Number(me.__391.style.opacity)>0||!me.__391.style.opacity)?'inherit':'hidden';
					me.__391.ggVisible=true;
				}
				else {
					me.__391.style.visibility="hidden";
					me.__391.ggVisible=false;
				}
			}
		}
		me.__391.logicBlock_visible();
		me.__391.ggCurrentLogicStateSize = -1;
		me.__391.ggCurrentLogicStateVisible = -1;
		me.__391.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__391.childNodes.length; i++) {
				var child=me.__391.childNodes[i];
		...
		me.__391.ggUpdatePosition=function (useTransition) {
			me.__391.ggUpdate();
		}
		me.__3959.appendChild(me.__391);
		el=me.__591=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__591;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		...
		el.ggUpdate = function(filter) {
			if(me.__591.ggUpdating == true) return;
			me.__591.ggUpdating = true;
			var el=me.__591;
			var curNumRows = 0;
			curNumRows = me.__591.ggNumRepeat;
			if (curNumRows < 1) curNumRows = 1;
			if (typeof filter=='object') {
				el.ggFilter = filter;
			} else {
			...
			var centerOffsetHor = 0;
			var centerOffsetVert = 0;
				me.__591.ggCloneOffsetChanged = false;
			}
			el.ggCurrentFilter = filter;
			el.ggInstances = [];
			if (el.hasChildNodes() == true) {
			...
			var currentIndex = 0;
			var keepCloning = true;
			tourNodes = me.__591.getFilteredNodes(tourNodes, filter);
			me.__591.ggNumFilterPassed = tourNodes.length;
			for (var i = 0; i < tourNodes.length; i++) {
				var nodeId = tourNodes[i];
				var nodeData = player.getNodeUserdata(nodeId);
				if (!keepCloning || i < me.__591.ggCloneOffset) continue;
				var parameter={};
				parameter.top = centerOffsetVert + (row * me.__591.ggHeight) + 'px';
				parameter.left = centerOffsetHor + (column * me.__591.ggWidth) + 'px';
				parameter.width=me.__591.ggWidth + 'px';
				parameter.height=me.__591.ggHeight + 'px';
				parameter.index=currentIndex;
				parameter.title=nodeData['title'];
				var inst = new SkinCloner__591_Class(nodeId, me, el, parameter);
				currentIndex++;
				el.ggInstances.push(inst);
				el.appendChild(inst.__div);
				inst.__div.ggObj=inst;
			...
			me.__591.ggNodeCount = me.__591.ggNumFilterPassed;
			me.__591.ggUpdating = false;
			player.triggerEvent('clonerchanged');
			if (me.__591.parentNode && me.__591.parentNode.classList.contains('ggskin_subelement') && me.__591.parentNode.parentNode.classList.contains('ggskin_scrollarea')) me.__591.parentNode.parentNode.ggUpdatePosition();
		}
		el.ggFilter = [];
		el.ggFilter[0] = "59";
		el.ggId="\uac00\uad6c\uc5c6\uc74c-59";
		...
		me.__591.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me.__591.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__591.ggCurrentLogicStateSize = newLogicStateSize;
				me.__591.style.transition='width 0s, height 0s';
				if (me.__591.ggCurrentLogicStateSize == 0) {
					me.__591.ggWidth=100;
					me.__591.ggHeight=150;
					me.__591.ggUpdate();
					skin.updateSize(me.__591);
				}
				else {
					me.__591.ggWidth=150;
					me.__591.ggHeight=200;
					me.__591.ggUpdate();
					skin.updateSize(me.__591);
				}
			}
		}
		me.__591.logicBlock_size();
		me.__591.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("59") != -1))
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me.__591.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__591.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__591.style.transition='width 0s, height 0s';
				if (me.__591.ggCurrentLogicStateVisible == 0) {
					me.__591.style.visibility=(Number(me.__591.style.opacity)>0||!me.__591.style.opacity)?'inherit':'hidden';
					me.__591.ggVisible=true;
				}
				else {
					me.__591.style.visibility="hidden";
					me.__591.ggVisible=false;
				}
			}
		}
		me.__591.logicBlock_visible();
		me.__591.ggCurrentLogicStateSize = -1;
		me.__591.ggCurrentLogicStateVisible = -1;
		me.__591.ggUpdateConditionNodeChange=function () {
			var cnode=player.getCurrentNode();
			for(var i=0; i<me.__591.childNodes.length; i++) {
				var child=me.__591.childNodes[i];
				if (child.ggObj && child.ggObj.ggNodeId==cnode) {
			        var childOffX = child.offsetLeft;
			        var childOffY = child.offsetTop;
					var p = child.parentElement;
		...
		me.__591.ggUpdatePosition=function (useTransition) {
			me.__591.ggUpdate();
		}
		me.__3959.appendChild(me.__591);
		me._scrollarea_1__content.appendChild(me.__3959);
		me.__54.appendChild(me._scrollarea_1);
		...
		me.__46.logicBlock_position = function() {
			...
			if (me.__46.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__46.style.transition='left 0s, top 0s, transform 0s';
				if (me.__46.ggCurrentLogicStatePosition == 0) {
					me.__46.style.left='-18px';
					me.__46.style.top='5px';
				}
				else {
					me.__46.style.left='0px';
					me.__46.style.top='4.8px';
				}
			}
		}
		...
		el=me.__390=document.createElement('div');
		els=me.__390__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="39";
		el.ggDx=20;
		...
		hs+='cursor : pointer;';
		hs+='height : 28px;';
		hs+='left : calc(50% - ((20% + 0px) / 2) + 20px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((28px + 0px) / 2) + 0px);';
		hs+='visibility : hidden;';
		hs+='width : 20%;';
		hs+='pointer-events:auto;';
		hs+='@import url(\"https:\/\/fonts.googleapis.com\/css2?family=Nanum+Gothic:wght@400;700&display=swap\"); font-family: \"Nanum Gothic\", sans-serif; line-height:14px;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		hs ='';
		hs += 'box-sizing: border-box;';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__390.ggUpdateText=function() {
			var params = [];
			var hs = player._("39", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me.__390.ggUpdateText();
		el.appendChild(els);
		me.__390.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__390.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("39") == -1))
			)
			...
			if (me.__390.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__390.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__390.style.transition='';
				if (me.__390.ggCurrentLogicStateVisible == 0) {
					me.__390.style.visibility=(Number(me.__390.style.opacity)>0||!me.__390.style.opacity)?'inherit':'hidden';
					me.__390.ggVisible=true;
				}
				else {
					me.__390.style.visibility="hidden";
					me.__390.ggVisible=false;
				}
			}
		}
		me.__390.logicBlock_visible();
		me.__390.onclick=function (e) {
			player.openNext("{node3}","");
		}
		me.__390.ggUpdatePosition=function (useTransition) {
		}
		me.__48.appendChild(me.__390);
		el=me.__590=document.createElement('div');
		els=me.__590__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="59";
		el.ggDx=70;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__590.ggUpdateText=function() {
			var params = [];
			var hs = player._("59", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me.__590.ggUpdateText();
		el.appendChild(els);
		me.__590.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__590.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("59") == -1))
			)
			...
			if (me.__590.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__590.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__590.style.transition='';
				if (me.__590.ggCurrentLogicStateVisible == 0) {
					me.__590.style.visibility=(Number(me.__590.style.opacity)>0||!me.__590.style.opacity)?'inherit':'hidden';
					me.__590.ggVisible=true;
				}
				else {
					me.__590.style.visibility="hidden";
					me.__590.ggVisible=false;
				}
			}
		}
		me.__590.logicBlock_visible();
		me.__590.onclick=function (e) {
			player.openNext("{node10}","");
		}
		me.__590.ggUpdatePosition=function (useTransition) {
		}
		me.__48.appendChild(me.__590);
		el=me.__39a=document.createElement('div');
		els=me.__39a__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="39A-\ud074\ub9ad";
		el.ggDx=20;
		...
		el.ggType='text';
		hs ='';
		hs+='background : rgba(255,255,127,0);';
		hs+='border : 0px solid #000000;';
		hs+='border-radius : 25px;';
		hs+='color : #000000;';
		hs+='cursor : pointer;';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__39a.ggUpdateText=function() {
			var params = [];
			var hs = player._("39\n", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		me.__39a.ggUpdateText();
		el.appendChild(els);
		me.__39a.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__39a.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize().width <= 460))
			)
			...
			if (me.__39a.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me.__39a.ggCurrentLogicStatePosition = newLogicStatePosition;
				me.__39a.style.transition='left 0s, top 0s, background-color 0s';
				if (me.__39a.ggCurrentLogicStatePosition == 0) {
					me.__39a.style.left = 'calc(50% - (20% / 2) + (0px / 2) + 10px)';
					me.__39a.style.top = 'calc(50% - (28px / 2))';
				}
				else if (me.__39a.ggCurrentLogicStatePosition == 1) {
					me.__39a.style.left = 'calc(50% - (20% / 2) + (0px / 2) + 10px)';
					me.__39a.style.top = 'calc(50% - (28px / 2))';
				}
				else {
					me.__39a.style.left='calc(50% - ((20% + 0px) / 2) + 20px)';
					me.__39a.style.top='calc(50% - ((28px + 0px) / 2) + 0px)';
				}
			}
		}
		me.__39a.logicBlock_position();
		me.__39a.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.ggUserdata.tags.indexOf("39") != -1))
			)
			...
			if (me.__39a.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me.__39a.ggCurrentLogicStateVisible = newLogicStateVisible;
				me.__39a.style.transition='left 0s, top 0s, background-color 0s';
				if (me.__39a.ggCurrentLogicStateVisible == 0) {
					me.__39a.style.visibility=(Number(me.__39a.style.opacity)>0||!me.__39a.style.opacity)?'inherit':'hidden';
					me.__39a.ggVisible=true;
				}
				else {
					me.__39a.style.visibility="hidden";
					me.__39a.ggVisible=false;
				}
			}
		}
		me.__39a.logicBlock_visible();
		me.__39a.logicBlock_backgroundcolor = function() {
			...
			if (me.__39a.ggCurrentLogicStateBackgroundColor != newLogicStateBackgroundColor) {
				me.__39a.ggCurrentLogicStateBackgroundColor = newLogicStateBackgroundColor;
				me.__39a.style.transition='left 0s, top 0s, background-color 0s';
				if (me.__39a.ggCurrentLogicStateBackgroundColor == 0) {
					me.__39a.style.backgroundColor="rgba(255,255,255,1)";
				}
				else {
					me.__39a.style.backgroundColor="rgba(255,255,127,0)";
				}
			}
		}
		me.__39a.logicBlock_backgroundcolor();
		me.__39a.onclick=function (e) {
			player.openNext("{node3}","");
		}
		me.__39a.ggUpdatePosition=function (useTransition) {
		}
		me.__48.appendChild(me.__39a);
		...
		me.__48.appendChild(me.__59);
		el=me._type=document.createElement('div');
		els=me._type__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="TYPE";
		el.ggDy=0;
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._type.ggUpdateText=function() {
			var params = [];
		...
		me.__39.logicBlock_position = function() {
			...
			if (me.__39.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__39.style.transition='left 500ms ease 0ms, bottom 500ms ease 0ms, transform 0s';
		...
		me.__39.logicBlock_scaling = function() {
			...
			if (me.__39.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__39.ggCurrentLogicStateScaling == 0) {
					me.__39.ggParameter.sx = 0.85;
					me.__39.ggParameter.sy = 0.8;
		...
		hs+='overflow : hidden;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((81.3559% + 0px) / 2) + 0%);';
		hs+='visibility : hidden;';
		hs+='width : 82%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='overflow : hidden;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((78.8136% + 0px) / 2) + 0%);';
		hs+='visibility : hidden;';
		hs+='width : 80%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me.__38.logicBlock_size = function() {
			...
			if (me.__38.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__38.ggCurrentLogicStateSize == 0) {
					me.__38.style.width='86%';
					me.__38.style.height='100%';
					me.__38.style.left = 'calc(50% - (86% / 2))';
		...
		hs+='overflow : hidden;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((113.988% + 0px) / 2) + 0%);';
		hs+='visibility : hidden;';
		hs+='width : 115%;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		hs+='position : absolute;';
		hs+='right : 15px;';
		hs+='top : calc(50% - ((430px + 0px) / 2) + 0px);';
		hs+='visibility : inherit;';
		hs+='width : 55px;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
		...
		me.__.logicBlock_position = function() {
			...
			if (me.__.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__.ggCurrentLogicStatePosition == 0) {
					...
					me.__.style.top = 'calc(50% - (430px / 2) + (0px / 2) + 5px)';
				}
				else {
					me.__.style.right='15px';
					me.__.style.top='calc(50% - ((430px + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me._rectangle_2.logicBlock_size = function() {
			...
			if (me._rectangle_2.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me._rectangle_2.style.transition='width 500ms ease-in 0ms, height 500ms ease-in 0ms';
		...
		me.__31.appendChild(me._timer_1);
		me.__2.appendChild(me.__31);
		...
		me.__20.logicBlock_text = function() {
			...
			if (me.__20.ggCurrentLogicStateText != newLogicStateText) {
				me.__20.ggCurrentLogicStateText = newLogicStateText;
				me.__20.style.transition='';
				if (me.__20.ggCurrentLogicStateText == 0) {
					if (me.__20.ggUpdateText) {
					me.__20.ggUpdateText=function() {
						var params = [];
					...
					me.__20.ggUpdateText();
						...
						if (me.__20.ggUpdatePosition) me.__20.ggUpdatePosition();
					}
				}
				else {
					if (me.__20.ggUpdateText) {
		...
		me.__20.logicBlock_text();
		me.__20.ggUpdatePosition=function (useTransition) {
		}
		me._onoff.appendChild(me.__20);
		me.__2.appendChild(me._onoff);
 ...
 let url = '';
  ...
  document.body.removeChild(textarea);
		...
		player.addListener('changenode', function(event) {
			...
			me.__54.logicBlock_position();
			me.__391.logicBlock_visible();
			me.__391.ggUpdateConditionNodeChange();
			me.__591.logicBlock_visible();
			me.__591.ggUpdateConditionNodeChange();
			me.__50.logicBlock_visible();
			me.__390.logicBlock_visible();
			me.__590.logicBlock_visible();
			me.__39a.logicBlock_visible();
		...
		player.addListener('sizechanged', function(event) {
			for(var i = 0; i < me.__591.ggInstances.length; i++) {
				me.__591.ggInstances[i].ggEvent_sizechanged(event);
			}
			for(var i = 0; i < me.__391.ggInstances.length; i++) {
				me.__391.ggInstances[i].ggEvent_sizechanged(event);
			}
			if (hotspotTemplates.hasOwnProperty('ht_node')) {
				for(var i = 0; i < hotspotTemplates['ht_node'].length; i++) {
	...
	function SkinCloner__591_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		...
		el=me._nodeimage_159=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._nodeimage_159;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._nodeimage_159__img=document.createElement('img');
		els.className='ggskin ggskin_nodeimage';
		els.setAttribute('src',basePath + "images/nodeimage_139_" + nodeId + ".png");
		el.ggNodeId=nodeId;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._nodeimage_159.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return this.ggNodeId;
		}
		me._nodeimage_159.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me._nodeimage_159.ggCurrentLogicStateSize != newLogicStateSize) {
				me._nodeimage_159.ggCurrentLogicStateSize = newLogicStateSize;
				me._nodeimage_159.style.transition='width 0s, height 0s';
				if (me._nodeimage_159.ggCurrentLogicStateSize == 0) {
					me._nodeimage_159.style.width='95px';
					me._nodeimage_159.style.height='95px';
					skin.updateSize(me._nodeimage_159);
				}
				else {
					me._nodeimage_159.style.width='115px';
					me._nodeimage_159.style.height='115px';
					skin.updateSize(me._nodeimage_159);
				}
			}
		}
		me._nodeimage_159.logicBlock_size();
		me._nodeimage_159.onclick=function (e) {
			if (me._nodeimage_159.isDragging()) return;
			player.openNext("{"+me.ggNodeId+"}","");
			player.setVariableValue('vis_roomchoice', false);
		}
		me._nodeimage_159.ggUpdatePosition=function (useTransition) {
		}
		el=me._rectangle_159=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._rectangle_159;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		el.ggId="Rectangle 1-59";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._rectangle_159.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._rectangle_159.ggUpdatePosition=function (useTransition) {
		}
		el=me.__592=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__592;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me.__592__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\uac00\uad6c\uc5c6\uc74c \ubc29\uc774\ub984-59";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__592.ggUpdateText=function() {
			var params = [];
		...
		me.__592.ggUpdateText();
		player.addListener('changenode', function() {
			me.__592.ggUpdateText();
		});
		el.appendChild(els);
		me.__592.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__592.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_159.appendChild(me.__592);
		me._nodeimage_159.appendChild(me._rectangle_159);
		me.__div.appendChild(me._nodeimage_159);
		me._nodeimage_159.logicBlock_size();
			me.ggEvent_sizechanged=function(event) {
				me._nodeimage_159.logicBlock_size();
			};
	};
	function SkinCloner__391_Class(nodeId, parentScope, ggParent, parameter) {
		var me=this;
		var hs='';
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		el=me._nodeimage_139=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._nodeimage_139;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me._nodeimage_139__img=document.createElement('img');
		els.className='ggskin ggskin_nodeimage';
		els.setAttribute('src',basePath + "images/nodeimage_139_" + nodeId + ".png");
		el.ggNodeId=nodeId;
		hs ='';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._nodeimage_139.ggIsActive=function() {
			return player.getCurrentNode()==this.ggElementNodeId();
		}
		el.ggElementNodeId=function() {
			return this.ggNodeId;
		}
		me._nodeimage_139.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize().width <= 670))
			)
			...
			if (me._nodeimage_139.ggCurrentLogicStateSize != newLogicStateSize) {
				me._nodeimage_139.ggCurrentLogicStateSize = newLogicStateSize;
				me._nodeimage_139.style.transition='width 0s, height 0s';
				if (me._nodeimage_139.ggCurrentLogicStateSize == 0) {
					me._nodeimage_139.style.width='95px';
					me._nodeimage_139.style.height='95px';
					skin.updateSize(me._nodeimage_139);
				}
				else {
					me._nodeimage_139.style.width='115px';
					me._nodeimage_139.style.height='115px';
					skin.updateSize(me._nodeimage_139);
				}
			}
		}
		me._nodeimage_139.logicBlock_size();
		me._nodeimage_139.onclick=function (e) {
			if (me._nodeimage_139.isDragging()) return;
			player.openNext("{"+me.ggNodeId+"}","");
			player.setVariableValue('vis_roomchoice', false);
		}
		me._nodeimage_139.ggUpdatePosition=function (useTransition) {
		}
		el=me._rectangle_139=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me._rectangle_139;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		el.ggId="Rectangle 1-39";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		el.ggType='rectangle';
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me._rectangle_139.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._rectangle_139.ggUpdatePosition=function (useTransition) {
		}
		el=me.__392=document.createElement('div');
		el.isDragging = function() {
			let scrollerParent = me.__392;
			while ((scrollerParent = scrollerParent.parentNode) != null) {
				if (scrollerParent.hasOwnProperty('ggIsDragging') && scrollerParent.ggIsDragging == true) return true;
			}
			return false;
		}
		els=me.__392__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="\uac00\uad6c\uc788\uc74c \ubc29\uc774\ub984-39";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__392.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.ggUserdata.title)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
		...
		me.__392.ggUpdateText();
		player.addListener('changenode', function() {
			me.__392.ggUpdateText();
		});
		el.appendChild(els);
		me.__392.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__392.ggUpdatePosition=function (useTransition) {
		}
		me._rectangle_139.appendChild(me.__392);
		me._nodeimage_139.appendChild(me._rectangle_139);
		me.__div.appendChild(me._nodeimage_139);
		me._nodeimage_139.logicBlock_size();
			me.ggEvent_sizechanged=function(event) {
				me._nodeimage_139.logicBlock_size();
			};
		...
		me.__35.logicBlock_position = function() {
			...
			if (me.__35.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__35.ggCurrentLogicStatePosition == 0) {
					...
					me.__35.style.left='calc(50% - ((50px + 0px) / 2) + 0px)';
		...
		me.__34.logicBlock_position = function() {
			...
			if (me.__34.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__34.ggCurrentLogicStatePosition == 0) {
					me.__34.style.left = 'calc(50% - (60px / 2))';
					me.__34.style.bottom='0px';
				}
				else if (me.__34.ggCurrentLogicStatePosition == 1) {
					me.__34.style.left = 'calc(50% - (60px / 2) + (0px / 2) + -5px)';
					me.__34.style.bottom='40px';
				}
				else {
					me.__34.style.left='calc(50% - ((60px + 0px) / 2) + 0px)';
					me.__34.style.bottom='-40px';
				}
			}
		}
		...
		me.__34.logicBlock_size = function() {
			...
			if (me.__34.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__34.ggCurrentLogicStateSize == 0) {
					...
					me.__34.style.width='95px';
					me.__34.style.height='25px';
					me.__34.style.left = 'calc(50% - (95px / 2))';
					skin.updateSize(me.__34);
				}
				else {
					me.__34.style.width='60px';
		...
		me._map_pin_normal2.logicBlock_size = function() {
			...
			if (me._map_pin_normal2.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me._map_pin_normal2.ggCurrentLogicStateSize == 0) {
					...
					me._map_pin_normal2.style.top = 'calc(50% - (22px / 2) + (0px / 2) + -5px)';
					...
					me._map_pin_normal2.style.top = 'calc(50% - (44px / 2) + (0px / 2) + -5px)';
					skin.updateSize(me._map_pin_normal2);
				}
			}
		}
